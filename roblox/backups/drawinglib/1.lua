...
local Maid = loadstring(game:HttpGet('https://raw.githubusercontent.com/JayGitCuh/Jay/main/roblox/backups/drawinglib/2.lua'))()
local Signal = loadstring(game:HttpGet('https://raw.githubusercontent.com/JayGitCuh/Jay/main/roblox/backups/drawinglib/3.lua'))()
